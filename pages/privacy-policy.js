    ...
    <div>
      ...
      <div className={styles.privacy}>
        <div className="container">
          ...
          <h4>LAST UPDATE: MAY 06, 2020</h4>
          <p>
            This privacy policy aims to give information on how Selendra
            collects and processes your personal data when you use the Selendra
            Wallet and related services (Services) or use the Selendra Wallet
            website (www.Selendra.com). Our website and Services are not
          ...
          <p>
            ...
            information to third parties and, for the avoidance of doubt, we
            will only use and store your personal information in the
          ...
          <p>
            1. We may collect, store and use the following kinds of personal
            data about you which we have grouped together as follows:
          </p>
          <p>
            <span>1. Communication Data:</span> includes information contained
            in or relating to any communications that you send to us or send
            through our website any other personal information that you choose
            to send to us.
          </p>
          <p>
            <span>2. Service Data:</span> includes information that you provide
            to us when using our Services, or that is generated in the course of
            the use thereof;
          </p>
          <p>
            <span>3. Technical Data:</span> includes internet protocol (IP)
          ...
          <p>
            4.We do not collect any Special Categories of Personal Data about
            ...
            genetic and biometric data). Nor do we collect your credit or debit
            card details.
          </p>
          <h4>How is your personal data collected</h4>
          <p>
            1. We use different methods to collect data from and about you
            including through:
          </p>
          <p>
            <span>1.Automated technologies or interactions:</span> as you
          ...
          <p>
            <span>2.Third parties or publicly available sources:</span> We may
            receive your personal data from third party content providers using
            our Services.
          </p>
          ...
          <p>
            1.to administer our Services and business (including
            troubleshooting, testing, system maintenance, support, reporting and
            hosting of data);
          </p>
          <p>
            2.to personalise our Services or website for you (including
            delivering relevant website content and advertisements);
          </p>
          <p>
            3.to use data analytics to improve our website, products/Services,
            marketing, customer relationships and experiences.
          </p>
          <p>
            4. We will only use your personal data for the purposes for which it
            was collected, unless we reasonably consider that we need to use it
            ...
            contact us on support@Selendra.com.
          </p>
          <h4>Disclosure of your personal data</h4>
          <p>
            1. We may disclose your personal data to any of our employees,
            officers, insurers, service providers, professional advisers, HM
            Revenue & Customs insofar as reasonably necessary for the purposes
            set out in paragraph 4 above
          </p>
          <p>
            2. We may disclose personal data to our subsidiaries insofar as
            reasonably necessary for the purposes of paragraph 4 above
          </p>
          <p>
            Except as provided in this policy, we will not provide your personal
          ...
          <h4>Securing your personal information</h4>
          <p>
          ...
          <p>
            ...
            us to continue to process it. You also have the right to delete or
            remove data where you have successfully exercised your right to
            object to processing (see below). Note, however, that we may not
          ...
          <p>
            ...
            something about your particular situation which makes you object to
            processing.
          </p>
          <p>
            5.Request restriction of processing of your personal data. You may
            instruct us at any time not to process your personal information for
            marketing purposes.
          </p>
          <p>
          ...
          <p>
            We rely on third party services to provide you with our Services. We
          ...
          <h4>Cookies</h4>
          <p>
            1. Our website uses cookies. A cookie is a file containing an
          ...
          <p>
            4. We use session and persistent cookies on our website as well as
            the localStorage capabilities of your browser.
          </p>
          <p>
            5. Blocking or deleting any or all cookies may have a negative
            impact upon the usability of our Services or may practically exclude
            you from using them completely.
          </p>
          <h4>Our Details</h4>
          <p>
            The Services are owned and operated by Selendra. Selendra is
            brainchild of SmallWorld Venture 2F-01, Raintree, #299 Preah Ang
            Duong, Sangkat Wat Phnom, Khan Daun Penh, Kingdom of Cambodia. You
            can contact us by writing to the business address given above or by
            email to info@Selendra.com.
          </p>
        </div>
      </div>
    </div>
